...
-- Volcando datos para la tabla fabrica-galletitas.orders: ~1 rows (aproximadamente)
REPLACE INTO `orders` (`id`, `store`, `date`, `address`, `status`) VALUES
	(1, 2, '2024-10-14', 'moron 124', 0);
...
-- Volcando datos para la tabla fabrica-galletitas.sessions: ~1 rows (aproximadamente)
