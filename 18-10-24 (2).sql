...
REPLACE INTO `orders` (`id`, `store`, `order`, `date`, `status`, `code`) VALUES
	...
	(4, 2, '3 de tussi con merca', '2024-10-16', 3, 1081),
	(5, 2, 'quiero 2 kilos de penes', '2024-10-16', 0, 9235),
	(6, 2, 'y 4 de waska', '2024-10-16', 2, 8939);
...
-- Dumping data for table fabrica-galletitas.orders_logs: ~5 rows (approximately)
REPLACE INTO `orders_logs` (`id`, `order`, `user`, `date`, `newStatus`, `comments`) VALUES
	...
	(5, 4, 12, '2024-10-18 14:20:53', 2, ''),
	(6, 1, 12, '2024-10-18 14:27:39', 2, ''),
	(7, 4, 12, '2024-10-18 14:27:46', 2, ''),
	(8, 6, 12, '2024-10-18 14:27:50', 2, '');
...
REPLACE INTO `sessions` (`id`, `userId`, `device`, `application`, `ip`, `logged`) VALUES
	...
	(44, 13, 'Microsoft Windows', 'Chrome', '127.0.0.1', '2024-10-18 14:28:05');
...
-- Dumping structure for table fabrica-galletitas.trips
CREATE TABLE IF NOT EXISTS `trips` (
  ...
  CONSTRAINT `FK_trips_orders` FOREIGN KEY (`order`) REFERENCES `orders` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_trips_vehicles` FOREIGN KEY (`vehicle`) REFERENCES `vehicles` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table fabrica-galletitas.trips: ~3 rows (approximately)
REPLACE INTO `trips` (`id`, `order`, `vehicle`) VALUES
	(1, 1, 1),
	(2, 4, 1),
	(3, 6, 2);
...
-- Dumping structure for table fabrica-galletitas.vehicles
...
-- Dumping data for table fabrica-galletitas.vehicles: ~2 rows (approximately)
