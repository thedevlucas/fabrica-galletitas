...
REPLACE INTO `users` (`id`, `group`, `username`, `password`, `name`, `lastname`, `phone`) VALUES
	...
	(10, 'cliente', 'cliente', '$2a$10$hGvC.x1qeoc4zFarGgTJIeh/I0O0cpOtFcdoJOANZKcBZxm9EfeOK', 'Cliente', 'Clientado', '11548759487'),
...
-- Volcando datos para la tabla fabrica-galletitas.vehicles: ~1 rows (aproximadamente)
