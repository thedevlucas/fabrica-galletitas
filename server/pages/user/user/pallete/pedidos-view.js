...
module.exports = (router, database) => 
{
    ...
    router.get('/paletizador/pedidos/view/:id', async (req, res) => {
        ...
        try {
            ...
            res.render('user/home', { content: "pallete/pedidos-view", order: results[0] });
        } catch (error) {
            console.error(error);
        } finally {
            con.end();
    ...
    router.post('/paletizador/pedidos/check/:id', async (req, res) => {
        ...
        try {
            ...
            const [results_insert] = await con.promise().query('INSERT INTO orders_logs SET ?', {order: params.id, user: user.id, comments: body.comments});
